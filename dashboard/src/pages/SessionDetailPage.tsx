            ...
            <div className="stack">
              <div className="surface-panel">
                <div className="stack-heading">
                  ...
                  <p>Latest execution trace with stage counts and a direct path into the full trace workspace.</p>
                </div>
                <div className="pill-group">
                ...
                {activeTraceID ? (
                  <div className="inline-actions">
                    <Link className="button button--primary" to={`/sessions/${sessionId}/traces/${activeTraceID}`}>
              ...
              <div className="trace-list">
                ...
                {execution.trace && filteredTraceEntries.length > tracePreviewEntries.length ? <div className="data-table__empty">Showing the latest trace items here. Open the full trace workspace for the complete sequence.</div> : null}
